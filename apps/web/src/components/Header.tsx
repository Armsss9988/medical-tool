        ...
        <div className="flex items-center space-x-2.5 sm:space-x-3.5 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center space-x-1.5 sm:space-x-2">
              ...
              {isSyncing && (
                <span
                  data-testid="header-sync-indicator"
                  className="inline-flex items-center gap-1 text-[10px] font-bold bg-amber-500/15 text-amber-300 border border-amber-400/30 px-2 py-0.5 rounded-md shadow-xs animate-pulse"
                  title="Hệ thống đang đồng bộ dữ liệu với máy chủ"
                >
