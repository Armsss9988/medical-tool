...
import { SelectedTest, AutoConclusionDomainService } from '@domain';
...
export default function ConclusionForm({ 
  ...
  // ─── SMART AUTO-CONCLUSION (DOMAIN SERVICE) ─────────────────────────
  const smartConclusion = useMemo(() => {
    return AutoConclusionDomainService.generate(selectedTests || []);
  }, [selectedTests]);
